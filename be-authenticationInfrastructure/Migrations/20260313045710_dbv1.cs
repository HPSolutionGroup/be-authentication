    ...
    public partial class dbv1 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PermissionGroupTypes", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserInBranches", x => new { x.UserId, x.BranchId });
                    table.ForeignKey(
                        name: "FK_UserInBranches_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserInBranches_Branches_BranchId",
                        column: x => x.BranchId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PermissionGroups_PermissionGroupTypes_GroupTypeId",
                        column: x => x.GroupTypeId,
                        principalTable: "PermissionGroupTypes",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserPermissionGroups", x => new { x.UserId, x.PermissionGroupId, x.BranchId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserPermissionGroups_Branches_BranchId",
                        column: x => x.BranchId,
                        principalTable: "Branches",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CommandInFunctions", x => new { x.FunctionId, x.CommandId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserPermissions", x => new { x.UserId, x.FunctionId, x.CommandId, x.BranchId });
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserPermissions_Commands_CommandId",
                        column: x => x.CommandId,
                        principalTable: "Commands",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_UserPermissions_Functions_FunctionId",
                        column: x => x.FunctionId,
                        principalTable: "Functions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("d4e5f6a7-b8c9-4d0e-1f2a-3b4c5d6e7f8a"), 0, "https://res.cloudinary.com/da3m7fj99/image/upload/v1732819079/admin_hpdxlr.png", "B7NC4P2XQZ5LKA2YTR7WJDF3G6VHS5EM", null, "superadmin@gmail.com", true, true, false, null, "Super_Admin", null, "SUPERADMIN@GMAIL.COM", "AQAAAAIAAYagAAAAEKbe9jemyzuRM+++7n+Y9WEj6qUY4jkgwyDvTklziegEgGnvlNrAtLntxq/Jf0j/cQ==", null, false, "N9WM7PKRYL4J3AV26GTXUEQB0CZMFH51", false, "superadmin@gmail.com" },
                    { new Guid("e5f6a7b8-c9d0-4e1f-2a3b-4c5d6e7f8a9b"), 0, "https://res.cloudinary.com/da3m7fj99/image/upload/v1732819079/admin_hpdxlr.png", "P4XQ2P7ZNCL5BKA3YTR2WJDF6G5VHS7E", null, "admin@gmail.com", true, true, false, null, "Admin", "ADMIN@GMAIL.COM", "ADMIN@GMAIL.COM", "AQAAAAIAAYagAAAAENMDX9oFcZWdcRT7hu3+h9wuwLtrLoMr//hXJyXJzRBOo5kSH6L+WfX4JzHnVyx+DQ==", null, false, "VHHP3SM5ARZNAMM6YNEZY6SQXWQ6YYIJ", false, "admin@gmail.com" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CommandInFunctions_CommandId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PermissionGroups_GroupTypeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserInBranches_BranchId",
                table: "UserInBranches",
                column: "BranchId");

            migrationBuilder.CreateIndex(
                name: "IX_UserPermissionGroups_BranchId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserPermissionGroups_UserId_BranchId",
                table: "UserPermissionGroups",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserPermissions_CommandId",
                table: "UserPermissions",
                column: "CommandId");

            migrationBuilder.CreateIndex(
                name: "IX_UserPermissions_FunctionId",
                table: "UserPermissions",
                column: "FunctionId");
